...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<actionpack>.freeze, ["< 7.1", ">= 3.2.0"])
      s.add_development_dependency(%q<railties>.freeze, ["< 7.1", ">= 3.2.0"])
      ...
      s.add_dependency(%q<actionpack>.freeze, ["< 7.1", ">= 3.2.0"])
      s.add_dependency(%q<railties>.freeze, ["< 7.1", ">= 3.2.0"])
